...
export const selectUserShortcuts = (state: RootState): Array<any> | undefined => undefined;

export const selectUserSettings = (state: RootState): Array<any> | undefined => undefined;
